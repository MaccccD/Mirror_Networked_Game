...
At its core, Bomb Squad aims to capture the pressure and thrill of racing against time to diffuse a ticking bomb. 
The collaborative effort in the game is facilitated by a text chat system, allowing players to exchange important information with one another to progress the story and gameplay activities. 
It is targeted at young people, aged 18-35.
...
What to do after opening the ".exe" file :

For full game playability, please ensure that the person who joins as the host chooses the “Office Player” role, while the one who joins as the client chooses the “Bomb Player” role.

Steps to follow when playing: 

PC 1: Connect as HOST
PC 2: Connect as CLIENT


PC 2 (CLIENT): Press START FIRST
PC1 (HOST): Press START SECOND


PC 1 (HOST): Choose OFFICE PLAYER FIRST
PC 2 (CLIENT): Choose BOMB PLAYER SECOND
